...
function AddCat(props: Props) {
  ...
  return (
    <>
      ...
      <Modal visible={visible} title="Add new Cat" onOk={handleOk} onCancel={handleCancel} confirmLoading={loading}>
        <Form form={form} layout="vertical" name="addCatForm">
          ...
          <Form.Item name="avatar" label="Avatar" rules={[{ required: true, message: 'Please enter the cat avatar' }]}>
            <Input />
          </Form.Item>
        </Form>
      </Modal>
